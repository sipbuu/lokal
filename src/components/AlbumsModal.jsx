...
import { X, Search, Play, Disc3 } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto">
        {tracks.map((t, i) => (
          <button key={t.id} onDoubleClick={() => playQueue(tracks, i)}
            className="w-full flex items-center gap-3 px-6 py-2.5 hover:bg-elevated transition-colors group text-left">
            <span className="text-xs text-muted w-5 font-display">{t.track_num || i + 1}</span>
