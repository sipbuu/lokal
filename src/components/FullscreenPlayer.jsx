...
import { X, Play, Pause, SkipBack, SkipForward, Heart, Shuffle, Repeat, Repeat1, Mic2, ListMusic } from 'lucide-react'
    ...
    <AnimatePresence>
      {showFullscreen && (
        ...
        >
          ...
          {}
          <div className="relative z-10 flex flex-col items-center justify-center flex-1 px-12 py-8 mr-auto pl-48">
            {}
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="w-64 h-64 rounded-2xl overflow-hidden shadow-[0_32px_80px_rgba(0,0,0,0.8)] border border-white/10 mb-8 flex-shrink-0 bg-white/5 flex items-center justify-center"
              >
                {artSrc
          ...
          {}
          <div className="relative z-10 flex flex-col overflow-hidden" style={{ width: '420px' }}>
            {}
            <div className="px-8 pt-6 pb-3 flex-shrink-0">
              ...
              {currentTrack && <p className="text-xs text-white/20 mt-0.5 truncate">{currentTrack.title} — {currentTrack.artist}</p>}
            </div>
